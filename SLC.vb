...
#Region " State Handling "
    ...
    Protected State As MouseState2
    Private Sub SetState(ByVal current As MouseState2)
        State = current
        Invalidate()
    End Sub
    ...
    Protected Overrides Sub OnEnabledChanged(ByVal e As EventArgs)
        If Enabled Then SetState(MouseState2.None) Else SetState(MouseState2.Block)
        MyBase.OnEnabledChanged(e)
    End Sub

    Protected Overrides Sub OnMouseEnter(ByVal e As EventArgs)
        SetState(MouseState2.Over)
    ...
    Protected Overrides Sub OnMouseDown(ByVal e As MouseEventArgs)
        If e.Button = Windows.Forms.MouseButtons.Left Then SetState(MouseState2.Down)
...
#Region " State Handling "
    ...
    Protected Overrides Sub OnMouseUp(ByVal e As MouseEventArgs)
        If InPosition Then SetState(MouseState2.Over)
        MyBase.OnMouseUp(e)
    End Sub
...
#Region " Variables"
    ...
    Private State As MouseState2 = MouseState2.None
#End Region
...
#Region " Properties"
    ...
    Protected Overrides Sub OnMouseUp(ByVal e As MouseEventArgs)
        MyBase.OnMouseUp(e)
        State = MouseState2.Over : TB.Focus() : Invalidate()
    End Sub
